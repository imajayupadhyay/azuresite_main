<template>
    <div class="min-h-screen bg-gray-50">
        <Sidebar />
        <Topbar :title="`Edit ${certification.code}`" :subtitle="certification.name" />
...
const form = ref({
    certification_category_id: props.certification.certification_category_id || '',
    code: props.certification.code || '',
    name: props.certification.name || '',
    slug: props.certification.slug || '',
    description: props.certification.description || '',
    long_description: props.certification.long_description || '',
    level_color: props.certification.level_color || 'blue',
    exam_duration: props.certification.exam_duration || '',
    questions: props.certification.questions || '',
    passing_score: props.certification.passing_score || '',
    exam_cost: props.certification.exam_cost || '',
    duration: props.certification.duration || '',
    last_updated: props.certification.last_updated || '',
    prerequisites: props.certification.prerequisites || [],
    target_audience: props.certification.target_audience || [],
    modules: props.certification.modules || [],
    skills: props.certification.skills || [],
    resources: props.certification.resources || [],
    faqs: props.certification.faqs || [],
    meta_title: props.certification.meta_title || '',
    meta_description: props.certification.meta_description || '',
...
const submitForm = () => {
    ...
    router.put(route('admin.certifications.update', props.certification.id), data, {
        onFinish: () => {
