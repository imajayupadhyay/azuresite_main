                    ...
                    <div>
                        <form @submit.prevent="subscribeNewsletter" class="flex gap-3">
                            <input 
                                ...
                                required
                                class="flex-1 px-5 py-3 bg-white/10 backdrop-blur-lg border-2 border-white/20 rounded-xl text-white placeholder-white/60 focus:border-primary-400 focus:ring-2 focus:ring-primary-400/50 outline-none transition-all"
                            />
                            <button 
                                type="submit"
                                class="px-8 py-3 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-400 hover:to-primary-500 rounded-xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg"
                            >
                                Subscribe
                            </button>
                        </form>
