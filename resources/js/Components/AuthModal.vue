        ...
        >
            ...
            >
                <div 
                    v-if="isOpen"
                    @click.stop
                    class="relative w-full max-w-md bg-white dark:bg-navy-800 rounded-3xl shadow-2xl overflow-hidden"
                >
                    <!-- Close Button -->
                    <button
                        @click="closeModal"
                        class="absolute top-4 right-4 z-10 p-2 rounded-lg text-gray-400 dark:text-navy-400 hover:text-gray-600 dark:hover:text-navy-200 hover:bg-gray-100 dark:hover:bg-navy-700 transition-colors"
                    >
                    ...
                    <div class="p-8">
                        <!-- Login Form -->
                        <!-- Error Messages -->
                        <div v-if="$page.props.errors && Object.keys($page.props.errors).length > 0" class="mb-4 bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-800 rounded-lg p-4">
                        ...
                        >
                            <form v-if="activeTab === 'login'" @submit.prevent="handleLogin" class="space-y-4">
                                <!-- Email -->
                                <div>
                                    <label class="block text-sm font-semibold text-navy-900 dark:text-white mb-2">Email Address</label>
                                    <input 
                                        ...
                                        class="w-full px-4 py-3 border-2 border-gray-200 dark:border-navy-600 rounded-xl bg-white dark:bg-navy-700 text-gray-900 dark:text-white focus:border-primary-500 focus:ring-2 focus:ring-primary-200 dark:focus:ring-primary-800 outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                    />
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <label class="flex items-center">
                                        ...
                                        />
                                        <span class="ml-2 text-sm text-navy-700 dark:text-navy-300">Remember me</span>
                                    </label>
                                ...
                                <div class="relative my-6">
                                    <div class="absolute inset-0 flex items-center">
                                        <div class="w-full border-t border-gray-300 dark:border-navy-600"></div>
                                    </div>
                                    <div class="relative flex justify-center text-sm">
                                        <span class="px-4 bg-white dark:bg-navy-800 text-gray-500 dark:text-navy-400">Or continue with</span>
                                    </div>
                                </div>

                                <div class="grid grid-cols-2 gap-3">
                                    <button type="button" class="flex items-center justify-center px-4 py-2.5 border-2 border-gray-200 dark:border-navy-600 rounded-xl hover:bg-gray-50 dark:hover:bg-navy-700 transition-colors">
                                        ...
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-navy-300">Google</span>
                                    </button>
                                    <button type="button" class="flex items-center justify-center px-4 py-2.5 border-2 border-gray-200 dark:border-navy-600 rounded-xl hover:bg-gray-50 dark:hover:bg-navy-700 transition-colors">
                                        ...
                                        <span class="ml-2 text-sm font-medium text-gray-700 dark:text-navy-300">GitHub</span>
                                    </button>
                                </div>
                            </form>
                            ...
                            <form v-else @submit.prevent="handleSignup" class="space-y-4">
                                ...
                                <div>
                                    <label class="flex items-start">
                                        ...
                                        />
                                        <span class="ml-2 text-sm text-navy-700 dark:text-navy-300">
                                            I agree to the 
                                ...
                                <div class="relative my-6">
                                    ...
                                    <div class="relative flex justify-center text-sm">
                                        <span class="px-4 bg-white dark:bg-navy-800 text-gray-500 dark:text-navy-400">Or sign up with</span>
                                    </div>
                                </div>
